...
Date: 1 - 29 - 2017
Project: Compiler Assignment 2. The task is to extend the updated
compiler template given to us by importing our corrected code 
from Compiler 1 and extending it to generate P-Code.
Any and all P-code generation extensions that have been 
inserted have a blank line seperating them from imported code. 
'''
import sys, string
    ...
    while True:
        ...
        #     JPC COMMAND
            ...
            if stack[top] == instr.statLinks:
                pos = instr.value
            top -= 1
        ##ADDED IN CTS command for program 
        elif instr.cmd == "CTS":
            top +=1 
